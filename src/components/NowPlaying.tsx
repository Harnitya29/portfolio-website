  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center">
        <h3 className="text-violet-300 text-sm font-bold tracking-wider mb-4">
          NOW PLAYING
        </h3>
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <a
        ...
        className="flex items-center gap-4 p-3 rounded-lg backdrop-blur-sm border border-zinc-800/50 hover:border-violet-300/30 transition-colors"
      >
        {/* Album art */}
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-2 w-full relative h-1">
            ...
            <div 
              className="absolute h-full rounded-full bg-violet-300"
        ...
        <div className="ml-2 w-6 h-6 flex items-center justify-center">
          {song.is_playing ? (
            <div className="w-4 h-4 text-violet-300 flex gap-1">
      ...
      <a 
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="mt-3 opacity-50 flex items-center gap-1 text-[10px] text-gray-500 hover:opacity-100 hover:text-violet-400 transition-all"
      >
