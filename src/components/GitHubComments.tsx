  ...
  return (
    ...
    >
      <div className="border-t border-zinc-800 pt-10">
        ...
        >
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-violet-300 via-violet-300 to-teal-300">
            Comments
          </span>
          <motion.span
            className="absolute -bottom-1 left-0 h-[2px] w-full bg-gradient-to-r from-violet-300/0 via-violet-300 to-violet-300/0"
            initial={{ width: 0 }}
