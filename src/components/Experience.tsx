...
const experience = [
  {
    ...
    description:
      "building projects at the intersection of web, AI, and security",
    link: "",
    color: "#f87171",
  },
  
  {
    title: "occasional debugger",
    position: "self-reflection",
    date: "present",
    description:
      "occasionally debugging my own procrastination",
    link: "",
    color: "#fcd34d",
  }
];
    ...
    >
      ...
      <div className="mt-10 relative">
        ...
        {experience.map((exp, index) => {
          ...
          // Pre-calculate character animations for better performance
