...
export async function GET(request: Request) {
  ...
  const text = title ? `harnitya | ${title}` : "harnitya | home";
        ...
        >
          ...
          <div
            style={{
              ...
              borderRadius: "30px",
              padding: "1px",
              background: "linear-gradient(135deg, rgba(167, 139, 250, 0.3), rgba(6, 182, 212, 0.1), rgba(167, 139, 250, 0.3))",
          ...
          >
            ...
            >
              ...
              >
                Software Engineer • Building systems, interfaces, and intelligent experiences.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div
            style={{
              ...
              height: "130px",
              borderRadius: "50%",
              background: "linear-gradient(135deg, rgba(167, 139, 250, 0.5), rgba(6, 182, 212, 0.3))",
              opacity: 0.5,
            }}
          />
