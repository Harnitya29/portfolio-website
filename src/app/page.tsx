...
const ArchiveTeaser = dynamic(() => import("~/components/ArchiveTeaser"), { ssr: true });
                    ...
                    {[...Array(8)].map((_, i) => (
                      <motion.div
                        ...
                        style={{
                          left: '50%',
                          top: '50%',
                          backgroundColor: `hsl(${160 + i * 2}, ${80 + i * 1}%, ${70 + i * 2}%)`,
                        }}
                          ...
                          {[...Array(4)].map((_, j) => (
                            <motion.div
                              ...
                              style={{
                                left: '50%',
                                top: '50%',
                                backgroundColor: `hsl(${142 + i * 3 + j * 2}, ${80 + i * 1 + j * 1}%, ${70 + i * 2 + j * 1}%)`,
                              }}
...
>
  <LocationSection />
        ...
        {/* Education Section placeholder - Can be added later if needed */}                    <motion.section
                              initial="hidden"
                              whileInView="visible"
                              viewport={{ once: true, margin: "-100px" }}
                              custom={3}
